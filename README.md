...
- Contact section: click-to-call, WhatsApp deep link, embedded Google Map, **working hours** (set once in Settings → Booking, shown to every customer — or per-branch hours if the business has multiple branches), **social media icon row** (only shows platforms the Owner has filled in)
